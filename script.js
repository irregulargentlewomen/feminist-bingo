(function($) {
  ...
  var sourceArray = [
    ...
    ['explain-it-to-me', "So if you know all about feminism, explain it to me.", "No one owes you an education. If you want to learn, <a href=\"http://lmgtfy.com/?q=feminism+101\">you can google it</a>."],
  	...
  	['laid', "You'll never get laid with that attitude.", "Getting 'laid' isn't the point. Justice is the point."],
  	...
  	['jealous', "You're only jealous because you don't look like that.", "You're only jealous because you don't look like that."],
  	...
  	['human-nature', "Human nature is never going to change. You're just wasting your time.", "What human nature? Cultures vary widely across time and space &mdash; go read some history and anthropology."],
  	...
  	['love-it-if-a-babe', "I'd love it if a babe forced herself on me sexually.", "Not according to <a href=\"http://www.malesurvivor.org/speaking-out.html\">these survivors</a>."],
      ...
      generateSquares = function(data) {
        var x, y,
            ...
            sectionTag = function(x, y, slug, content) {
              return '<section class="square" id="' +
                x + '-' + y + '"><span class="' +
                slug + '">' +
            ...
            listTag = function(source) {
              return '<li class="' +
                source[0] + '"><span class="comment">' +
                source[1] + '</span><span class="retort">' +
                source[2] + '</span></li>';
            };
